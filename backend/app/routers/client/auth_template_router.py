...
# @router.get("/login", response_class=HTMLResponse)  # React로 대체됨
# async def login_page(request: Request):
#     return templates.TemplateResponse("auth/login.html", {"request": request, "title": "로그인"})

# @router.post("/login")  # React로 대체됨 (API 라우터 사용)
...
# @router.get("/register", response_class=HTMLResponse)  # React로 대체됨
# async def register_page(request: Request):
#     return templates.TemplateResponse("auth/register.html", {"request": request, "title": "회원가입"})

# @router.post("/register")  # React로 대체됨 (API 라우터 사용)
...
# @router.get("/auth/forgot-password", response_class=HTMLResponse)  # React로 대체됨
...
# @router.get("/auth/reset-password", response_class=HTMLResponse)  # React로 대체됨
...
# @router.get("/admin-required", response_class=HTMLResponse)  # React로 대체됨
...
# @router.get("/member-required", response_class=HTMLResponse)  # React로 대체됨
