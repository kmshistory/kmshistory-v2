...
class User(Base):
    ...
    email_verification_code = Column(String(6), nullable=True, comment="이메일 인증 코드")
    email_verification_expires = Column(DateTime(timezone=True), nullable=True, comment="인증 코드 만료시간")
...
class EmailVerification(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    email = Column(String(255), nullable=False, unique=True, comment="이메일 주소")
    verification_code = Column(String(6), nullable=False, comment="인증 코드")
